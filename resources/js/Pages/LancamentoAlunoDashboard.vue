                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container px-2 px-lg-5 px-xl-4">
                            ...
                            <p class="mb-4">Selecione o aluno para fazer os lançamentos</p>
                                        ...
                                        <table class="table table-striped table-bordered table-sm mb-0" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr v-for="aluno in alunos.data" :key="aluno.id">
                                                    ...
                                                    <td class="text-center"> <Link :href="'/lancamento/aluno/'+ aluno.id" ><i class="fa fa-arrow-right"></i></Link></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
